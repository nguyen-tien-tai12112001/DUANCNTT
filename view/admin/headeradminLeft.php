     ...
     <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
       ...
       <!-- Nav Item - Tables -->
       <li class="nav-item  <?php if (isset($_GET['action'])) if ($_GET['action'] == 'danhsachgiangvien') {
                              echo ' active';
                            } ?>">
       ...
       <hr class="sidebar-divider">
       <li class="nav-item <?php if (isset($_GET['action'])) if ($_GET['action'] == 'danhsachnhanvien') {
                              echo ' active';
                            } ?>">
       ...
       <hr class="sidebar-divider">
       <li class="nav-item  <?php if (isset($_GET['action'])) if ($_GET['action'] == 'danhsachsinhvien') {
                              echo ' active';
                            } ?>">
