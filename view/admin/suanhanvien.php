            ...
            <div class="container-fluid">
                ...
                <form method="POST">
                    <table width="100%">
                        <tbody class="table">
                            <tr>
                                <td class="modal-td" width="30%">Mã NV:</td>
                                <td class="modal-td"><input autocomplete="off" type="text" id="magiangvien" name="magiangvien" class="form-control" value="<?= $gvid['magiangvien'] ?>" readonly></td>
                            </tr>
                            <tr>
                                <td class="modal-td" width="30%">Tên nhân viên:</td>
                            ...
                            <tr>
                                ...
                                <td class="modal-td"><input autocomplete="off" type="text" class="form-control" value=" <?= $gvid['magiangvien'] ?>@thanglong.edu.vn" name="email" id="email" readonly></td>
                            </tr>
                            <tr>
