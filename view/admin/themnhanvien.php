                     ...
                     <table width="100%">
                         <tbody class="table">
                             ...
                             <tr>
                                 ...
                                 <td class="modal-td"><input autocomplete="off" type="text" id="hovaten" name="hovaten" class="form-control"></td>
                             </tr>
                             ...
                             <tr>
                                 ...
                                 <td class="modal-td"><input autocomplete="off" type="text" class="form-control" value="GV<?= $getmgv + 1 ?>@thanglong.edu.vn" name="email" id="email" readonly></td>
                             </tr>
                             <tr>
