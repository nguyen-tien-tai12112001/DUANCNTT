                   ...
                   <div class="card-body">
                     <div class="row no-gutters align-items-center">
                       <div class="col mr-2">
                         ...
                         <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $countsSV[0]['sl'] ?></div>
                       </div>
                       <div class="col-auto">
               ...
               <div class="col-xl-3 col-md-6 mb-4">
                 <div class="card border-left-info shadow h-100 py-2">
                   <div class="card-body">
                     <div class="row no-gutters align-items-center">
                       <div class="col mr-2">
                         <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Số lượng môn học
                         </div>
                         <div class="row no-gutters align-items-center">
                           <div class="col-auto">
                             <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?= $monhocSL[0]['sl'] ?></div>
                           </div>
                         </div>
                       </div>
                       <div class="col-auto">
                     ...
                     <div class="row no-gutters align-items-center">
                       <div class="col mr-2">
                         <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                           Số lượng chuyên ngành</div>
                         <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $chuyennganhSL[0]['sl'] ?></div>
                       </div>
                       <div class="col-auto">
                         <i class="fas fa-calendar fa-2x text-gray-300"></i>
                       </div>
               ...
               <div class="col-xl-8 col-lg-7">
                 <div class="card shadow mb-4">
                   ...
                   <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                     <h6 class="m-0 font-weight-bold text-primary">Biểu đồ đường</h6>
                   </div>
                   <!-- Card Body -->
                   <div class="card-body">
     ...
     <script>
       ...
       // Area Chart Example
       var bienx = [<?= $countsSVNam[0]['sl'] ?>, <?= $countsSVNu[0]['sl'] ?>, <?= $countsGVNam[0]['sl'] ?>, <?= $countsGVNu[0]['sl'] ?>];
       var ctx = document.getElementById("myAreaChart");
       var myLineChart = new Chart(ctx, {
         type: 'line',
         data: {
           labels: ["Sv Nam", "Sv Nữ", 'Gv Nam', 'Gv Nữ'],
           datasets: [{
             label: "Earnings",
             lineTension: 0.3,
     ...
     <script>
       ...
       Chart.defaults.global.defaultFontColor = '#858796';
       // Pie Chart Example
       var bieny = [<?= $countsSV[0]['sl'] ?>, <?= $countsGV[0]['sl'] ?>, <?= $countsNV[0]['sl'] ?>];
       var ctx = document.getElementById("myPieChart");
       var myPieChart = new Chart(ctx, {
         type: 'doughnut',
         data: {
           labels: ["Sinh viên", "Giáo Viên", "Nhân viên"],
           datasets: [{
             data: bieny,
