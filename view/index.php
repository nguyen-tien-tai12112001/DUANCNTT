...
<body>
  <div class="limiter">
    <div class="container-login100" style="background-image: url('images/bg-01.jpg')">
      <div class="wrap-login100">
        <form method="post" id="ctl00" class="">

          <span class="login100-form-logo">
            <img id="profile-img" class="profile-img-card" src="./view/images/logotlu.jpg" />
          </span>

          <span class="login100-form-title p-b-34 p-t-27">Đăng nhập </span>

          <div class="wrap-input100 validate-input" data-validate="Điền tên đăng nhập">
            <input name="taikhoan" type="text" id="taikhoan" class="input100" placeholder="Tên đăng nhập" />
            <span class="focus-input100" data-placeholder="&#xf207;"></span>
          </div>

          <div class="wrap-input100 validate-input" data-validate="Điền mật khẩu">
            <input name="password" type="password" id="password" class="input100" placeholder="Mật khẩu" />
            <span class="focus-input100" data-placeholder="&#xf191;"></span>
          </div>

          <div class="contact100-form-checkbox">
            <input name="ckb1" type="checkbox" id="ckb1" class="input-checkbox100" checked="checked" />
          ...
          <br />
          <div>
            <a href="?controller=login&action=quenmk" class="text-white">Quên mật khẩu nhấn vào dòng này</a>
          </div>
          <br />
  ...
  <script type="text/javascript">
    $("#ctl00").submit(function(e) {
      ...
      // console.log("🚀 ~ file: index.php ~ line 112 ~ $ ~ password", password)
      let check = taikhoan[0];
      // console.log("🚀 ~ file: index.php ~ line 113 ~ $ ~ taikhoan", taikhoan)
