            ...
            <table width="100%">
              <tbody id="" class="table">
                <tr>
                  ...
                  <td class="modal-td"><input type="text" class="form-control" id="machuyennganh" name="machuyennganh" value="<?=$info['machuyennganh']?>"  readonly></td>
                </tr>
                <tr>
                  <td class="modal-td" width="30%">Tên chuyên ngành</td>
                  <td class="modal-td"><input type="text" class="form-control" id="tenchuyennganh" name="tenchuyennganh" value="<?=$info['tenchuyennganh']?>"></td>
                </tr>
